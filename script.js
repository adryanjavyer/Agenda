...
const services = [
  { id: "pe-barba", name: "PE + Barba", duration: "30 min", price: "R$ 20,00", icon: "✦", image: "PE + Barba.png" },
  { id: "cabelo", name: "Cabelo", duration: "40 min", price: "R$ 30,00", icon: "◆", image: "Cabelo.png" },
  { id: "barba-cabelo", name: "Barba + Cabelo", duration: "1h", price: "R$ 45,00", icon: "★", image: "Barba + Cabelo.png" },
  { id: "corte-pigmentacao", name: "Corte + Pigmentação", duration: "1h", price: "R$ 55,00", icon: "•", image: "Corte + Pigmentação.png" },
];
  ...
  servicesList.innerHTML = services.map((item) => `
    <button type="button" class="option-card service-card ${state.serviceId === item.id ? "selected" : ""}" data-service-id="${item.id}">
      <span class="service-left">
        <span class="service-photo" aria-hidden="true">
